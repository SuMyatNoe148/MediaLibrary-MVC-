...
class CatalogRepository extends BaseRepository implements CatalogRepositoryInterface
{
    public function getcatalog_count($category = null, $search = null)
    {
        ...
        $result->bindValue(':search', $search, $search === null ? PDO::PARAM_NULL : PDO::PARAM_STR);
    ...
    public function get_full_catalog($limit = null, $offset = 0)
    {
        ...
        $result->bindParam(1, $limit, $limit === null ? PDO::PARAM_NULL : PDO::PARAM_INT);
    ...
    public function get_category_catalog($category, $limit = null, $offset = 0)
    {
        ...
        $result->bindParam(2, $limit, $limit === null ? PDO::PARAM_NULL : PDO::PARAM_INT);
    ...
    public function get_search_catalog($search, $category = null, $limit = null, $offset = 0)
    {
        ...
        $result->bindValue(1, $search, $search === null ? PDO::PARAM_NULL : PDO::PARAM_STR);
        $result->bindValue(2, $category, $category === null ? PDO::PARAM_NULL : PDO::PARAM_STR);
